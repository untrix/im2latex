...
with tf.device('/cpu:*'):
    ...
    ed1 = tfc.edit_distance3D(3, 2, h2, l2, h1, l1, 100)
    mean1 = tf.reduce_mean(ed1)
    acc1 = tf.reduce_mean(tf.to_float(tf.equal(ed1, 0)))
    ed1_s = tfc.edit_distance3D(3, 2, h2_s, l2_s, h1_s, l1_s, 100)
    ...
    _ed1 = tfc.edit_distance2D(6, _h2, _l2, _h1, _l1, 100)
    _mean1 = tf.reduce_mean(_ed1)
    _acc1 = tf.reduce_mean(tf.to_float(tf.equal(_ed1, 0)))
    _ed1_s = tfc.edit_distance2D(6, _h2_s, _l2_s, _h1_s, _l1_s, 100)
    ...
    ed2 = tfc.edit_distance3D(3, 2, h2_2, l2_2, h1, l1, 100)
    acc2 = tf.reduce_mean(tf.to_float(tf.equal(ed2, 0)))
    sum2 = tf.reduce_sum(ed2)
    ed2_s = tfc.edit_distance3D(3, 2, h2_2_s, l2_2_s, h1_s, l1_s, 100)
    ...
    _ed2 = tfc.edit_distance2D(6, _h2_2, _l2_2, _h1, _l1, 100)
    _ed2_s = tfc.edit_distance2D(6, _h2_2_s, _l2_2_s, _h1_s, _l1_s, 100)
